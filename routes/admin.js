...
dashbaordRoutes.post("/addproduct", ProductsController.products_create_product);

dashbaordRoutes.patch("/:productId", ProductsController.products_update_product);

dashbaordRoutes.delete("/:productId",  ProductsController.products_delete);

dashbaordRoutes.delete("/:adminId", AdminController.admin_delete);
